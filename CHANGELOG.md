...
- feat: add sessionToken handling to support Grafana Assume Role in [#741](https://github.com/grafana/iot-sitewise-datasource/pull/741)
...
- chore: update renovate config to use data-sources base preset in [#733](https://github.com/grafana/iot-sitewise-datasource/pull/733)
...
- chore(deps): update dependency @playwright/test to v1.58.1 in [#697](https://github.com/grafana/iot-sitewise-datasource/pull/697)
- fix(deps): update module github.com/grafana/grafana-plugin-sdk-go to v0.287.0 in [#709](https://github.com/grafana/iot-sitewise-datasource/pull/709)
- fix(deps): update dependency @grafana/plugin-ui to ^0.13.0 in [#705](https://github.com/grafana/iot-sitewise-datasource/pull/705)
- Implement JSON string parsing to extract anomaly-related fields for property query type in [#704](https://github.com/grafana/iot-sitewise-datasource/pull/704)
- chore(deps): update actions/checkout digest to de0fac2 in [#702](https://github.com/grafana/iot-sitewise-datasource/pull/702)
- chore(deps): update dependency @grafana/plugin-e2e to v3.2.1 in [#701](https://github.com/grafana/iot-sitewise-datasource/pull/701)
- chore(deps): update dependency @grafana/aws-sdk to v0.9.0 in [#700](https://github.com/grafana/iot-sitewise-datasource/pull/700)
- fix(deps): update module github.com/grafana/grafana-aws-sdk to v1.4.3 in [#699](https://github.com/grafana/iot-sitewise-datasource/pull/699)
- chore(deps): update dependency @testing-library/react to v16.3.2 in [#694](https://github.com/grafana/iot-sitewise-datasource/pull/694)
- chore(deps): update dependency sass to v1.97.3 in [#696](https://github.com/grafana/iot-sitewise-datasource/pull/696)
- chore(deps): update dependency @grafana/plugin-e2e to v3.2.0 in [#698](https://github.com/grafana/iot-sitewise-datasource/pull/698)
- fix(deps): update module github.com/grafana/grafana-plugin-sdk-go to v0.286.0 in [#688](https://github.com/grafana/iot-sitewise-datasource/pull/688)
- chore(deps): update grafana/plugin-ci-workflows/ci-cd-workflows action to v6.1.0 in [#693](https://github.com/grafana/iot-sitewise-datasource/pull/693)
- chore(deps): update dependency lodash to v4.17.23 [security] in [#695](https://github.com/grafana/iot-sitewise-datasource/pull/695)
- chore(deps): update dependency @types/glob to v9 in [#674](https://github.com/grafana/iot-sitewise-datasource/pull/674)
- chore(deps): update dependency eslint-plugin-jsdoc to v62 in [#683](https://github.com/grafana/iot-sitewise-datasource/pull/683)
- chore(deps): update dependency prettier to ^3.8.0 in [#692](https://github.com/grafana/iot-sitewise-datasource/pull/692)
- fix(deps): update go patch updates in [#689](https://github.com/grafana/iot-sitewise-datasource/pull/689)
- chore(deps): update dependency eslint-plugin-prettier to ^5.5.4 in [#690](https://github.com/grafana/iot-sitewise-datasource/pull/690)
- chore(deps): update actions/checkout action to v6 in [#672](https://github.com/grafana/iot-sitewise-datasource/pull/672)
- chore(deps): update node.js to v24 in [#681](https://github.com/grafana/iot-sitewise-datasource/pull/681)
- chore(deps): update dependency lefthook to ^2.0.13 in [#687](https://github.com/grafana/iot-sitewise-datasource/pull/687)
- chore(deps): update dependency react-router-dom to v6.30.3 in [#686](https://github.com/grafana/iot-sitewise-datasource/pull/686)
- chore(deps): update dependency @types/lodash to ^4.17.21 in [#685](https://github.com/grafana/iot-sitewise-datasource/pull/685)
- chore(deps): update dependency sass to v1.97.2 in [#661](https://github.com/grafana/iot-sitewise-datasource/pull/661)
- chore(deps): update dependency @types/node to ^22.19.3 in [#684](https://github.com/grafana/iot-sitewise-datasource/pull/684)
- use prod environment for cd workflow in [#658](https://github.com/grafana/iot-sitewise-datasource/pull/658)
- chore(deps): update dependency eslint-plugin-jsdoc to ^61.5.0 in [#682](https://github.com/grafana/iot-sitewise-datasource/pull/682)
- chore(deps): update dependency glob to v13 in [#678](https://github.com/grafana/iot-sitewise-datasource/pull/678)
- chore(deps): update dependency eslint-plugin-jsdoc to v61 in [#676](https://github.com/grafana/iot-sitewise-datasource/pull/676)
- chore(deps): update dependency @grafana/eslint-config to v9 in [#673](https://github.com/grafana/iot-sitewise-datasource/pull/673)
- chore(deps): update dependency lefthook to v2 in [#679](https://github.com/grafana/iot-sitewise-datasource/pull/679)
- fix(deps): update module golang.org/x/sync to v0.19.0 in [#671](https://github.com/grafana/iot-sitewise-datasource/pull/671)
- fix(deps): update module github.com/aws/aws-sdk-go-v2/config to v1.32.6 in [#670](https://github.com/grafana/iot-sitewise-datasource/pull/670)
- fix(deps): update dependency @grafana/plugin-ui to ^0.12.0 in [#669](https://github.com/grafana/iot-sitewise-datasource/pull/669)
- chore(deps): update typescript-eslint monorepo to ^8.51.0 in [#675](https://github.com/grafana/iot-sitewise-datasource/pull/675)
- chore(deps): update typescript-eslint monorepo to ^8.39.0 in [#667](https://github.com/grafana/iot-sitewise-datasource/pull/667)
- chore(deps): update yarn to v4.12.0 in [#668](https://github.com/grafana/iot-sitewise-datasource/pull/668)
- chore(deps): update testing-library monorepo in [#666](https://github.com/grafana/iot-sitewise-datasource/pull/666)
- chore(deps): update jest monorepo to ^30.2.0 in [#665](https://github.com/grafana/iot-sitewise-datasource/pull/665)
- chore(deps): update dependency webpack to ^5.104.1 in [#663](https://github.com/grafana/iot-sitewise-datasource/pull/663)
- chore(deps): update dependency typescript to v5.9.3 in [#662](https://github.com/grafana/iot-sitewise-datasource/pull/662)
- chore(deps): update dependency @types/node to ^22.17.0 in [#653](https://github.com/grafana/iot-sitewise-datasource/pull/653)
- chore(deps): update dependency cspell to ^9.4.0 in [#660](https://github.com/grafana/iot-sitewise-datasource/pull/660)
- chore(deps): update dependency @grafana/eslint-config to ^8.1.0 in [#614](https://github.com/grafana/iot-sitewise-datasource/pull/614)
- chore(deps): update dependency @playwright/test to v1.57.0 in [#652](https://github.com/grafana/iot-sitewise-datasource/pull/652)
- chore(deps): update dependency @grafana/aws-sdk to v0.8.3 in [#613](https://github.com/grafana/iot-sitewise-datasource/pull/613)
- fix(deps): update module github.com/aws/aws-sdk-go-v2/service/iotsitewise to v1.52.13 in [#659](https://github.com/grafana/iot-sitewise-datasource/pull/659)
- chore(deps): update dependency react-router-dom to v6.30.2 in [#651](https://github.com/grafana/iot-sitewise-datasource/pull/651)
- chore(deps): update dependency @types/lodash to ^4.17.20 in [#650](https://github.com/grafana/iot-sitewise-datasource/pull/650)
- chore(deps): update dependency glob to v11.1.0 [security] in [#635](https://github.com/grafana/iot-sitewise-datasource/pull/635)
- chore(deps): update module golang.org/x/crypto to v0.45.0 [security] in [#633](https://github.com/grafana/iot-sitewise-datasource/pull/633)
- Update grafana-aws-sdk to 1.4.2 in [#657](https://github.com/grafana/iot-sitewise-datasource/pull/657)
- Update to use self-hosted renovate and remove dependabot in [#656](https://github.com/grafana/iot-sitewise-datasource/pull/656)
- chore(deps): bump grafana/plugin-ci-workflows/.github/workflows/cd.yml from 4.2.0 to 4.3.0 in [#641](https://github.com/grafana/iot-sitewise-datasource/pull/641)
- chore(deps): bump grafana/plugin-ci-workflows/.github/workflows/ci.yml from 4.2.0 to 4.3.0 in [#642](https://github.com/grafana/iot-sitewise-datasource/pull/642)
- chore(deps): bump the aws-sdk-go-v2 group with 2 updates in [#640](https://github.com/grafana/iot-sitewise-datasource/pull/640)
- chore(deps-dev): bump the npm-patch-dev-dependencies group across 1 directory with 5 updates in [#637](https://github.com/grafana/iot-sitewise-datasource/pull/637)
- chore(deps): bump the aws-sdk-go-v2 group with 3 updates in [#623](https://github.com/grafana/iot-sitewise-datasource/pull/623)
- chore(deps): bump github.com/aws/smithy-go from 1.22.5 to 1.23.1 in [#621](https://github.com/grafana/iot-sitewise-datasource/pull/621)
